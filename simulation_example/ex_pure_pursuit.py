...
def main():
    ...
    # cy = [0, 10, -10, 10, 0,  6]
    # 경로 정보 입력
    cx = [0, 0.5, 1, 1.5, 2, 2.5, 5, 6]
    cy = [0, 0.5, 0.5, 0.5, 2.5, 2.5, 2.5, 2.5]
    # 목표 속도 설정
    target_speed = 0.6
    ...
    while T >= time and lastIndex > target_ind:
        ...
        states.append(time, state)
        ## -------------------- 시리얼 통신 -------------------- ##
        print("di", di * 180 / 3.141592)  # di : radian -> degree
        # 제어패킷 전송
        # state.v * 3.6 = km/h 변환
        ...
        print("vi", state.v)
        serWrite(int((state.v * 400)), 1550 - int((di * 180 / 3.141592) * 35 / 3))
        # 패킷 간 딜레이 설정
        sleep(0.015)
        ## --------------------------------------------------- ##
